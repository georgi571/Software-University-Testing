package _4ProgrammingJavaOOPFebruary2024._9UnitTesting._2Exercises.p02_ExtendedDatabase;
...
public class DatabaseTest {
    ...
    private static final String NOT_VALID_NAME = "Kevin Yeegar";
    ...
    private static final Person ELEMENT_TO_ADD_DUPLICATE_NAME = new Person(4, "Cross Marian");
    private static final Person ELEMENT_TO_ADD_DUPLICATE_ID = new Person(1, "Kevin Yeegar");
